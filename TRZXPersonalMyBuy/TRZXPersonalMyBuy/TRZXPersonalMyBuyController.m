...
@property (strong, nonatomic) NSString *str1Url;
...
- (void)viewDidLoad {
    ...
    _tableView.mj_footer = [MJRefreshAutoNormalFooter footerWithRefreshingBlock:^{
        ...
        if(_pageNo <=_totalPage){
            ...
            NoLabelView *noLabelView = [[[NSBundle mainBundle]loadNibNamed:@"NoLabelView" owner:self options:nil] objectAtIndex:0];
            noLabelView.backgroundColor = backColor;
            noLabelView.frame = CGRectMake(0, 0, self.view.frame.size.width, 40);
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    if([_title1Str isEqualToString:@"股转公司说"]||[_title1Str isEqualToString:@"股交中心说"]){
        cell.nameLabel.hidden = YES;
        [cell.iconImageView sd_setImageWithURL:[NSURL URLWithString:mode.videoImg] placeholderImage:[UIImage imageNamed:@"展位图"]];
